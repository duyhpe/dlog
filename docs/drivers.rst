Khởi tạo: Cài đặt trình điều khiển
--------------------

You can implement new drivers for the :mod:`pyttsx3.Engine` by:

#. Tạo một Mô-đun Python mới.
#. Khai báo thư viện sử dụng vào Mô-đun
#. Sử dụng phương thức được xây dựng để truy cập các chức năng của thư viện

Giao tiếp:
~~~~~~~~~~~~~~~~~~~~

Tất cả các chức năng của thư viện đều được sử dụng với phương thức truy cập như sau:
.. module:: pyttsx3.drivers
   :Tóm tắt: The package containing the available driver implementations

.. Chức năng:: buildDriver(proxy : pyttsx3.driver.DriverProxy) -> pyttsx3.drivers.DriverDelegate
